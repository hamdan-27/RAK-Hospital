...
<head>
  ...
  <title>Update Admin Details - RAK Hospital</title>
...
<body style="background:url('assets\img\rak.jpg'); background-size: auto; opacity: 1;">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-group" action="update_scripts.php" method="POST" enctype="multipart/form-data">
                  ...
                  <br><br>
                  <center><input type="submit" name="admin-update" value="Update" class="btn btn-warning"></center>
                </form>
              </div>
            </div>
          </div>
