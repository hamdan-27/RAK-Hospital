...
if (isset($_POST['update-appoint'])) {
    $id = $_POST['id'];
    $pat_name =  $_POST['patient_name'];
    $spec = $_POST['doctor_speciality'];
    ...
    SET `patient_name`='$pat_name',`doctor_speciality`='$spec',`doctor_name`='$doc_name',`appointment_date`='$date',`appointment_time`='$time',`symptoms`='$symp',`date_registered`='$dateReg' 
    WHERE `id`='$id';";
    $result = mysqli_query($conn,$sql);

    if ($result) {
        echo "<script>alert('Appointment Updated Succesfully.')</script>";
...
<head>
  ...
  <title>Update Appointments - RAK Hospital</title>
