...
<head>
  ...
  <main id="main">
    ...
    <div class="container" style="width: 400px;">
        <div class="card">
            <img src="assets/img/docc.png" class="mx-auto" height="100" width="100" style="padding:10px;" alt="doc logo">
            <div class="card-body">
                <center>
                ...
                <form class="form-group" action="add_process.php" method="post">
                    ...
                    <center>
                        <input type="submit" name="doctor-submit" class="btn btn-primary" value="Register">
                    </center>

                    <p class="text-center text-muted mt-5 mb-0">
                      Have already an account? <a href="doctor_login.php" class="fw-bold text-body">
                        <u>Login here</u></a></p>
                </form>
            </div>
        </div>
