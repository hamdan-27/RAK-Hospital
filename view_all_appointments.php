...
if (isset($_POST['delete-appoint'])) {
    $id = $_POST['id'];

    $sql = "DELETE FROM `appointments` WHERE `id` = '$id';";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        echo "<script>alert('Appointment cancelled succesfully')</script>";
        echo "<script>window.open('view_all_appointments.php','_self')</script>";
    } else {
...
<head>
    ...
    <title>Registered Appointments - RAK Hospital</title>
