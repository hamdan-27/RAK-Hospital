...
<head>
  ...
  <title>Patient Login - RAK Hospital</title>
...
<body style="background:url('assets/img/rak.jpg'); background-size:cover; opacity: 1;">
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container" style="width: 400px;">
        <div class="card">
          <img src="assets\img\figma\patient.png" class="mx-auto" style="padding-top:20px;" width="80" height="100">
          <div class="card-body">
            ...
            <form class="form-group" action="login_process.php" method="post">
              ...
              <center>
                <input type="submit" name="patientlogin" class="btn btn-primary" value="Login">
              </center>
