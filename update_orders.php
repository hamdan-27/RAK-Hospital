...
if (isset($_POST['update-order'])) {
    ...
    $sql = "UPDATE `orders` 
    SET `drug_name`='$name',`quantity`='$qty',`address`='$address',`patient`='$patient',`date`='$date',`status`='$status',`registered_by`='$reg_by' 
    WHERE `id`='$id';";
    $result = mysqli_query($conn,$sql);

    if ($result) {
        echo "<script>alert('Order Updated Succesfully.')</script>";
...
<head>
  ...
  <title>Update Orders - RAK Hospital</title>
