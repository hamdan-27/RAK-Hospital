...
<head>
  ...
  <title>Inner Page - RAK Hospital</title>
          ...
          <div class="col-md-3">
            <div class="list-group">
              <class="list-group-item active" style="background-color: #FF00FF; color: white; border-color: #06F2F8;">
                ...
                <a href="patient_appoint.php" class="list-group-item">Create Appointments</a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-group" method="POST" enctype="multipart/form-data">
                  ...
                  <center><input type="submit" name="subreport" value="Submit Report" class="btn btn-secondary">
                  </center>
