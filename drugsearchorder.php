...
<head>
  ...
  <title>Order Drugs - RAK Hospital</title>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form class="form-group" action="add_process.php" method="post">
              ...
              <input type="number" name="quantity" class="form-control" placeholder="Enter quantity" required><br>

              <label>Address</label>
              <input type="text" name="address" class="form-control" placeholder="Enter home address" required><br>

              <label>Patient Name</label>
              <input type="text" name="patient-name" class="form-control" value="<?php echo $_SESSION['name']; ?>" placeholder="Enter your name" readonly><br>

              <center>
                <input type="submit" name="orderdrug" class="btn btn-primary" value="Order">
              </center>
            </form>
          </div>
        </div>
