...
<body style="background:url('assets/img/patient.jpg'); background-repeat: no-repeat; background-size: 100%; opacity: 1;">
  ...
  <main id="main">
    ...
    <div class="container" style="width: 400px;">
        <div class="card">
            <img src="assets\img\figma\patient.png" class="mx-auto" style="padding:10px;" width="100" height="100">
            <div class="card-body">
                <center>
                ...
                <form class="form-group" action="add_process.php" method="post">
                    ...
                    <input type="text" name="gender" class="form-control" placeholder="Gender (M/F)" required>
                    <br>
                    ...
                    <center>
                        <input type="submit" name="patient-submit" class="btn btn-primary" value="Register">
                    </center>
                 
                    <p class="text-center text-muted mt-5 mb-0">
                      Have already an account? <a href="patient_login.php" class="fw-bold text-body">
                        <u>Login here</u></a></p>
                </form>
            </div>
        </div>
