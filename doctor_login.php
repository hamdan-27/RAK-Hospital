...
<head>
  ...
  <title>Doctor Login - RAK Hospital</title>
...
<body style="background:url('assets/img/hero-bg.jpg'); background-size: auto; opacity: 1;">
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="make_appointment.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Make an</span>
        Appointment</a>
  ...
  <main id="main">
    ...
    <section class="inner-page">
      <div class="container" style="width: 400px;">
        <div class="card">
          <img src="assets/img/docc.png" class="mx-auto" style="padding:10px;" width="100" height="100">
          <div class="card-body">
            ...
            <form class="form-group" action="login_process.php" method="post">
              ...
              <center>
                <input type="submit" name="doctorlogin" class="btn btn-primary" value="Login">
              </center>
