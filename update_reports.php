...
if (isset($_POST['update-report'])) {
    ...
    $sql = "UPDATE `report` 
    SET `patient_name`='$patient_name',`doctor_name`='$doctor_name',`diagnosis`='$diagnosis',`psyc_status`='$psyc_status',`chronic_disease`='$chronic_disease',`medications`='$medications',`advice`='$advice',`date`='$date' 
    WHERE `id` = '$id';";
    $result = mysqli_query($conn,$sql);

    if ($result) {
        echo "<script>alert('Report Updated Succesfully.')</script>";
...
<head>
  ...
  <title>Update Reports - RAK Hospital</title>
